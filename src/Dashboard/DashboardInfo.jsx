...
const DashboardInfo = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-blue-50 via-white to-blue-100 shadow-xl p-8 md:p-12 mb-8 mt-3 overflow-hidden rounded-lg">
      {/* Floating icons positioned absolutely inside this container */}
      <FloatingIcons parentRelative />
